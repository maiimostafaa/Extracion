    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.scanSection} onPress={handleScan}>
          ...
          <Text style={styles.scanSubtitle}>Point your camera at the bag to auto-fill the data</Text>
        </TouchableOpacity>
        ...
        <View style={styles.formContainer}>
          <View style={styles.inputRow}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData(prev => ({ ...prev, coffeeName: text }))}
            />
          </View>
          ...
          <View style={styles.inputRow}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData(prev => ({ ...prev, roasterDate: text }))}
            />
          </View>
          ...
          <View style={styles.inputRow}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData(prev => ({ ...prev, roasterLevel: text }))}
            />
          </View>
          ...
          <View style={styles.inputRow}>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData(prev => ({ ...prev, bagWeightG: text }))}
