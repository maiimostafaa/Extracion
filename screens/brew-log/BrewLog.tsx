...
import { brewLogEntry, coffeeBeanDetail, brewDetail } from "../../assets/types/BrewLog/brewLogEntry"
...
export default function BrewLogScreen() {
	...
	const sampleBrewLogEntry: brewLogEntry = {
	    id: 1,
		date: new Date('2024-06-15'),
		name: "Morning Espresso Blend",
		brewMethod: 'pour over',
		image: "https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=400&h=400&fit=crop", // Sample coffee image URL
		coffeeBeanDetail: {
		...
		brewDetail: {
			grindSize: 7, // Fine grind for espresso
			beanWeight: 18, // grams
			waterAmount: 36, // ml (double shot)
			ratio: 2, // 1:2 ratio
			brewTime: 28, // seconds
	...
	const sampleBrewLogEntry2: brewLogEntry = {
		id: 3,
		...
		brewDetail: {
			grindSize: 20, // Coarse grind for cold brew
			beanWeight: 80, // grams
			waterAmount: 640, // ml
			ratio: 8, // 1:8 ratio for concentrate
			brewTime: 86400, // 24 hours in seconds
	...
	const allBrewLogEntries: brewLogEntry[] = [
        {
            ...
            tasteRating: {
                'Gritty': 0, 'Smooth': 3, 'Body': 2, 'Clean': 2, 'Fruity': 1,
                'Floral': 0, 'Chocolate': 2, 'Nutty': 1, 'Caramel': 2, 'Roasted': 3,
                'Cereal': 0, 'Green': 0, 'Sour': 0, 'Bitter': 1, 'Sweet': 2, 'Salty': 0
            },
            rating: 2.2
        },
        {
            ...
            tasteRating: {
                'Gritty': 0, 'Smooth': 3, 'Body': 3, 'Clean': 1, 'Fruity': 0,
                'Floral': 0, 'Chocolate': 3, 'Nutty': 2, 'Caramel': 1, 'Roasted': 2,
                'Cereal': 1, 'Green': 0, 'Sour': 0, 'Bitter': 0, 'Sweet': 1, 'Salty': 0
            },
            rating: 4.0
        },
        {
            ...
            tasteRating: {
                'Gritty': 0, 'Smooth': 2, 'Body': 1, 'Clean': 3, 'Fruity': 3,
                'Floral': 3, 'Chocolate': 0, 'Nutty': 0, 'Caramel': 1, 'Roasted': 1,
                'Cereal': 0, 'Green': 0, 'Sour': 1, 'Bitter': 0, 'Sweet': 2, 'Salty': 0
            },
            rating: 4.7
        },
        {
            ...
            tasteRating: {
                'Gritty': 0, 'Smooth': 3, 'Body': 2, 'Clean': 2, 'Fruity': 1,
                'Floral': 0, 'Chocolate': 1, 'Nutty': 2, 'Caramel': 2, 'Roasted': 1,
                'Cereal': 0, 'Green': 0, 'Sour': 0, 'Bitter': 0, 'Sweet': 2, 'Salty': 0
            },
            rating: 3.8
        }
    ];
	...
	const filteredData = useMemo(() => {
		...
		return allBrewLogEntries.filter(entry => entry.brewMethod === selectedFilter);
